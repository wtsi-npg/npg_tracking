package npg_tracking::daemon::ultimagenstaging;
...
npg_tracking::daemon::ultimagenstaging

=head1 SYNOPSIS

=head1 DESCRIPTION

Daemon definition for the ultimagen staging monitor.
...
Marco M. Mosca E<lt>mm51@sanger.ac.ukE<gt>
