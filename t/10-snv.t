...
{ # This id_run, position, tag_index should return valid results
  ...
  lives_and { is $test->snv_file, "$snv_repos/Homo_sapiens/default/Human_all_exon_50MB/1000Genomes_hs37d5/Human_all_exon_50MB-1000Genomes_hs37d5.vcf.gz" } 'snv file found';
