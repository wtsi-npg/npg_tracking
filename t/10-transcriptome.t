...
foreach my $v ('ensembl_release_74','ensembl_release_75'){
...
##update sample xml so that Reference Genome has a transcriptome version : Homo_sapiens (1000Genomes_hs37d5 + ensembl_release_74)
...
while(<$ver_fh>){
       if (/Homo_sapiens\s+(\S+)/){
          print $ver_w_fh " " x 6 . "<value>Homo_sapiens (1000Genomes_hs37d5 + ensembl_release_74)</value>\n";
       }      
...
my $prefix_path_74 = catfile($tmp_repos, q[transcriptomes/Homo_sapiens/ensembl_release_74/1000Genomes_hs37d5/tophat2/1000Genomes_hs37d5.known]);
lives_and { is $test3->transcriptome_index_name, $prefix_path_74 } "Correctly found non-default transcriptome version index name path and prefix";
