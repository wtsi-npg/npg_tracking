...

{
    ...
    is($r->libs, undef, 'libs undefined');
    ...
    is($r->command('sf2-nfs'), 'staging_area_monitor /export/sf2', 'command to run');
    is($r->daemon_name, 'staging_area_monitor', 'daemon name');
    is($r->start(q[sf2-nfs]), qq[daemon -i -r -a 10 -n staging_area_monitor --umask 002 -A 10 -L 10 -M 10 -o $log_dir/staging_area_monitor-] . q[sf2-nfs] . qq[-2013.log -- staging_area_monitor /export/sf2], 'start command');
