...

{
    ...
    is($r->start(q[sf2-nfs]), qq[daemon -i -r -a 10 -n staging_area_monitor --env="PERL5LIB=$p5lib" --umask 002 -A 10 -L 10 -M 10 -o $log_dir/staging_area_monitor-sf2-nfs-2013.log -- $script /export/sf2], 'start command');
